...
namespace Web_TracNghiem_HTSV.Migrations
{
    ...
    [Migration("20240701094813_changetoStartedAt")]
    partial class changetoStartedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web_TracNghiem_HTSV.Models.Answer", b =>
                {
            ...
            modelBuilder.Entity("Web_TracNghiem_HTSV.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Web_TracNghiem_HTSV.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Web_TracNghiem_HTSV.Models.TestResult", b =>
                {
                    ...
                    b.HasOne("Web_TracNghiem_HTSV.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
